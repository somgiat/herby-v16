...
def get_contextual_insight(
    ...
    if asset_name == "ETF หุ้น":
        ...
        if "เกษียณ" in goal:
            ...
            return (
                ...
                "ETF อาจเป็นหนึ่งในทางเลือกที่ช่วย "
                "กระจายความเสี่ยงและสร้างวินัยการลงทุนได้"
            )

        if (
            experience == "ยังไม่เคยลงทุน"
            or experience == "น้อยกว่า 1 ปี"
        ):

            return (
                "💡 หากคุณยังอยู่ในช่วงเริ่มต้น "
                "ETF อาจเป็นจุดเริ่มต้นที่เรียบง่าย "
                "กว่าการเลือกหุ้นรายตัว "
                "และช่วยกระจายความเสี่ยงได้มากกว่า"
            )
    ...
    if asset_name == "Bitcoin":
        ...
        return (
            ...
            "การมีสินทรัพย์ที่ผันผวนสูง "
            "ไม่จำเป็นต้องหมายถึง "
            "การจัดสรรสัดส่วนที่สูงเสมอไป"
        )
    ...
    if asset_name == "หุ้นต่างประเทศ":
        ...
        if (
            ...
            return (
                ...
                "Herby อยากให้คุณโฟกัส "
                "ที่คุณภาพธุรกิจและระยะเวลา "
                "มากกว่าความผันผวนระยะสั้น"
            )
    ...
    if asset_name == "ทองคำ":
        ...
        return (
            ...
            "หรือเพื่อการเติบโตของเงินลงทุน\n\n"
            "คำตอบนี้จะช่วยกำหนดบทบาทของทองคำในพอร์ตได้ดีขึ้น"
        )
